...
export interface CardNavProps {
  logo?: string;
  logoAlt?: string;
  textLogo?: string; // New prop for text logo
  items: CardNavItem[];
  className?: string;
  ease?: string;
  baseColor?: string;
...
const CardNav: React.FC<CardNavProps> = ({
  logo,
  logoAlt = "Logo",
  textLogo, // Destructure the new prop
  items,
  className = "",
  ease = "power3.out",
  baseColor = "#fff",
...
const items: CardNavItem[] = [
  ...
  },
  {
    ...
    textColor: "#fff",
    links: [
      { label: "Email", ariaLabel: "Email us", href: "mailto:info@company.com" },
